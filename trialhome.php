  ...
  <div id="carouselExampleFade" class="carousel slide" data-ride="carousel">
         <div class="carousel-inner">
              <div class="carousel-item active">
                <img class="d-block w-200" src="images/imagee1.jpg" alt="First slide">
              </div>
            <div class="carousel-item">
               <img class="d-block w-200" src="images/imagge2.jpg" alt="Second slide">
            </div>
           <div class="carousel-item">
              <img class="d-block w-200" src="images/image3.png" alt="Third slide">
           </div>
           <div class="carousel-item">
             <img class="d-block w-200" src="images/image4.jpeg" alt="Fourth slide">
           </div>
        </div>
